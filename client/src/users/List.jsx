      ...
      <div className="lg:w-1/3 w-full">
        <div className="p-10">
          <div className="mb-10 flex items-center justify-between">
            ...
            <button
              className="bg-purple-700 text-white px-3 py-1.5 rounded"
              onClick={openModal}
            >
              Add User
            </button>
          ...
          {users.length > 0
            ? users.map((user, key) => (
                <EachUser key={key} user={user} fetchData={fetchData} />
              ))
            : ""}
          <div>
              ...
              (pg, key) => (
                <Link
                  className={`border px-3 py-1 mr-3 ${
                    myPage == key ? "bg-purple-600 text-purple-100" : ""
                  }`}
                  to={`?page=${key}`}
                  key={key}
                >
            ...
            <div className="fixed z-10 inset-0 overflow-y-auto">
              <div className="text-center">
                ...
                <div className="relative inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform-all sm:my-8 sm:max-w-lg w-full">
                  <form id="newform" onSubmit={storeUser} action="post">
