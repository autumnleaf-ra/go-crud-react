...
export default function EachUser({ user, fetchData }) {
  ...
  // Delete
  const deleteUser = () => {
    if(window.confirm("Are you sure want delete this user ?") === true ){
                        ...
                        <div className="fixed z-10 inset-0 overflow-y-auto">
                            <div className="text-center">
                                ...
                                <div className="relative inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform-all sm:my-8 sm:max-w-lg w-full">
                                    <form id={`edit-form-${user.id}`} onSubmit={updateUser} action="post">
                                    <div className="bg-white items-center">
                                        ...
                                        <div className="px-8 py-8">
                                                <div className="mb-5">
                                                <label className="block text-gray-700 text-sm font-bold mv-2">Name</label>
                                            ...
                                            <div className="mb-5">
                                                <label className="block text-gray-700 text-sm font-bold mv-2">Email</label>
                                                <input type="email" name="email" value={emailValue} onChange={(e) => setEmailValue(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required />
                                            </div>
                                            <div className="mb-5">
                                                <label className="block text-gray-700 text-sm font-bold mv-2">Date</label>
                                            ...
                                            <div className="mb-5">
                                                <label className="block text-gray-700 text-sm font-bold mv-2">City</label>
                                                ...
                                                <div className="mb-5">
                                                    <label className="block text-gray-700 text-sm font-bold mv-2">Country</label>
                                            ...
                                            <div className='flex justify-end'>
                                                <button type='submit' className='bg-blue-500 text-white py-1.5 px-4 rounded'>Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
